...
<center>
	...
	<tr><td class="info">법정생년월일</td>
		...
		<td class="input_info">
			...
			<input type="checkbox" name="sms_al" value="yes" id="input_yes1"/
			<% if(sms_al.equals("yes")) out.print("checked"); %>>SMS 광고 수신을 동의합니다.
			<input type="hidden" name="sms_al" value="no" id="input_no1"
			<% if(sms_al.equals("no")) out.print("checked"); %>>
		</td>
		</tr>
		<!-- 이메일 -->
		<tr>
			...
			<td class="input_info">
				...
				@<input type="text" name="input_info" value='<%=email_domain%>'>
					...
					<input type="checkbox" name="email_al" value="yes" id="input_yes2"/
					<% if(email_al.equals("yes")) out.print("checked"); %>>e-mail광고 수신을 동의합니다.
					<input type="hidden" name="sms_al" value="no" id="input_no2"
					<% if(email_al.equals("no")) out.print("checked"); %>>
			</td>
		</tr>
		<!-- 주소 -->
		<tr>
